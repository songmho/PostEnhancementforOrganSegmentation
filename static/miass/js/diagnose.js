...
//
//
// const main_view = document.getElementById('main_viewer');
...
//     const element = document.getElementById('main_viewer');
...
(function () {
            ...
            success: function (data) {
                if (data !== undefined){
                    ...
                    if (loc === 0)
                        ...
                        $("#main_viewer").attr("src", "data:image/png;base64,"+images[0]);
                        $("#txt_num").text(cur+1);
    ...
    $(document).keydown(function (event) {
        if (event.keyCode === 37){ // Left
            ...
            $("#txt_num").text(cur+1);
            $("#main_viewer").attr("src", "data:image/png;base64,"+images[cur]);
