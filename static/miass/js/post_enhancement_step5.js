    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#num_seqs_step1_s5").text(step1["num_slices_organ"]);
                $("#size_step1_s5").text(String(step1["min_size"]) + " ↤ " + step1["avg_size"] + " ↦ " + step1["max_size"]);
                $("#num_sl_org_step2_s5").text(step2["num_slices_organ"]);
                $("#num_seqs_step2_s5").text(step2["num_slices_organ"]);
                $("#num_rem_sl_step2_s5").text(step2["num_remedied_slices"]);
                $("#size_step2_s5").text(String(step2["min_size"]) + " ↤ " + step2["avg_size"] + " ↦ " + step2["max_size"]);
                $("#num_sl_org_step3_s5").text(step3["num_slices_organ"]);
                $("#num_seqs_step3_s5").text(step3["num_slices_organ"]);
                ...
                $("#num_seqs_step4_s5").text(step4["num_slices_organ"]);
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#num_seqs_step5_s5").text(step5["num_slices_organ"]);
