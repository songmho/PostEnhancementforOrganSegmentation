...
from util.mrcnn.config import Config
from util.mrcnn import model as modellib, utils
...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "../util/logs")
...
class LesionDataset(utils.Dataset):
    ...
    def load_lesion(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "lesion_data.json")))
